      ...
      <header>
        <div className='bg-[#2563EB]'>
          <div className='flex items-center justify-between p-2 w-[90%] m-auto max-md:w-full '>
            <div className='flex gap-4 items-center  max-md:flex-col'>
              ...
              <div className='relative max-md:w-full max-md:absolute max-md:left-0 max-md:top-[55px]'>
                ...
                <InputText
                  ...
                  addClassNames={'max-md:w-full rounded-md w-[400px] h-[50px] pl-[10px] text-[16px] px-8'}
                ...
                {searchKeyword && (
                  <div className='absolute bg-[#fff] w-full rounded-md z-30 p-5 h-[500px] overflow-auto'>
                    <div>
                      {products?.length > 0 ? (
            ...
            <div className='flex gap-4 items-center max-md:gap-3 max-md:pr-5'>
              {user ? (
          ...
          >
            {initialCategoryData &&
              initialCategoryData.map((category) => (
                <div
                  className='flex items-center group relative max-md:flex max-md:justify-between max-md:w-full max-md:pt-4  text-gray-800'
                  key={category._id}
                >
